package com.fuzs.puzzleslib_rs.config.deserialize;
...
public class RegistryEntrySerializer<T extends IForgeRegistryEntry<T>> implements JsonDeserializer<T>, JsonSerializer<T> {
    ...
    private T getRegistryEntry(JsonElement json, String memberName) {
        ...
        if (json.isJsonPrimitive()) {
            ...
            throw new JsonSyntaxException("Expected " + memberName + " to be of type " + this.getType() + ", was " + JSONUtils.toString(json));
        }
    }
