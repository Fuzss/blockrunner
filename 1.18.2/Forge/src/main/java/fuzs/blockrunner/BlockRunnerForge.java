...
public class BlockRunnerForge {
    ...
    public static void onGatherData(final GatherDataEvent evt) {
        evt.getGenerator().addProvider(new ModBlockTagsProvider(evt, BlockRunner.MOD_ID));
        evt.getGenerator().addProvider(new ModLanguageProvider(evt, BlockRunner.MOD_ID));
    }
}
